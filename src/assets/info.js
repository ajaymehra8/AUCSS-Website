export default [
  ...
  },
  {
    ...
    code: "<div class='p-[40px]  px-5 py-[30px]'>Content goes here</div>",
    extraInfo: [
      {
        title: "Padding Top",
        shortcut: "pt",
  ...
  },
  {
    ...
    code: '<div class=" border-gray-200 border-2 rounded-md">Box with border</div>',
    extraInfo: [
      {
        title: "Border Width",
      ...
      },
      {
        ...
        description:
          "Tailwind supports border colors like `border-black`, `border-red`, etc.",
  ...
  },
  {
    ...
    code: '<div class="bg-blue p-4">Background color example</div>',
    extraInfo: [
      {
