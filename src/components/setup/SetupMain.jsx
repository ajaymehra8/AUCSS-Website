        ...
        <div>
          ...
          <div className="mt-[30px]">
            ...
            <pre className="relative mt-3 bg-black/30 rounded-lg p-4 text-sm text-gray-300 font-mono cursor-pointer">
              ...
              <div className="overflow-x-auto cursor-pointer">
                {`<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/au-css@1.2.6/dest/index.css" />`}
              </div>
              <button
                onClick={async () => {
          ...
          <div className="mt-[30px]">
            ...
            <pre className="relative mt-3 bg-black/30 rounded-lg p-4 text-sm text-gray-300 font-mono cursor-pointer">
              {/* Copy Button */}
              <div className="overflow-x-auto cursor-pointer">
                {`<script src="https://cdn.jsdelivr.net/npm/au-css@1.2.6/js/arbitary-values.js"></script>`}
              </div>
              <button
                onClick={async () => {
                  await navigator.clipboard.writeText(
